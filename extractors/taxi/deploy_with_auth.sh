...
# This script updates the extractor to use SODA API authentication
#
...
# Step 4: Test authentication locally (optional)
...
print_section "Step 5: Build Docker Image"
...
print_section "Step 6: Push to Container Registry"
