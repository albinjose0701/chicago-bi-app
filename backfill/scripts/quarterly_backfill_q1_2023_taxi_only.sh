#!/bin/bash
#
# Resilient Q1 2023 Quarterly Backfill - TAXI ONLY
...
LOG_FILE="backfill_q1_2023_taxi_only_$(date +%Y%m%d_%H%M%S).log"
PROGRESS_FILE="q1_2023_taxi_progress.txt"
...
echo -e "${BLUE}================================================${NC}"
echo -e "${BLUE}Resilient Q1 2023 Backfill - TAXI ONLY${NC}"
echo -e "${BLUE}ULTRA-OPTIMIZED (2s delays)${NC}"
echo -e "${BLUE}================================================${NC}"
echo ""
echo -e "Quarter: ${GREEN}Q1 2023 (Jan 1 - Mar 31)${NC}"
...
# Main backfill logic
run_backfill() {
    print_info "Generating date range for Q1 2023..."
    ...
    echo ""
    echo -e "${BLUE}================================================${NC}"
    echo -e "${BLUE}Q1 2023 Taxi Backfill Summary${NC}"
    echo -e "${BLUE}================================================${NC}"
...
print_success "Q1 2023 Taxi Backfill Complete!"
echo -e "Log file: ${GREEN}${LOG_FILE}${NC}"
echo -e "Progress file: ${GREEN}${PROGRESS_FILE}${NC}"
