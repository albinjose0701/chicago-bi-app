-- =====================================================
-- Gold Layer: Taxi Daily Aggregations by ZIP Code
-- =====================================================
-- Purpose: Daily trip aggregations by pickup/dropoff ZIP
-- Source: silver_data.silver_trips_enriched
-- Granularity: pickup_zip, dropoff_zip, trip_date
-- Created: 2025-11-13
-- =====================================================

CREATE TABLE IF NOT EXISTS `chicago-bi-app-msds-432-476520.gold_data.gold_taxi_daily_by_zip`
PARTITION BY trip_date
CLUSTER BY pickup_zip, dropoff_zip
AS
SELECT
  -- Grouping dimensions
  pickup_zip,
